...
import 'package:openvibes2/CustomWidgets/add_playlist.dart';
import 'package:openvibes2/CustomWidgets/animated_text.dart';
import 'package:openvibes2/CustomWidgets/copy_clipboard.dart';
import 'package:openvibes2/CustomWidgets/download_button.dart';
import 'package:openvibes2/CustomWidgets/empty_screen.dart';
import 'package:openvibes2/CustomWidgets/equalizer.dart';
import 'package:openvibes2/CustomWidgets/gradient_containers.dart';
import 'package:openvibes2/CustomWidgets/like_button.dart';
import 'package:openvibes2/CustomWidgets/popup.dart';
import 'package:openvibes2/CustomWidgets/seek_bar.dart';
...
import 'package:openvibes2/Helpers/dominant_color.dart';
import 'package:openvibes2/Helpers/lyrics.dart';
import 'package:openvibes2/Helpers/mediaitem_converter.dart';
import 'package:openvibes2/Screens/Common/song_list.dart';
import 'package:openvibes2/Screens/Search/albums.dart';
                            ...
                            builder: (context) {
                              return SimpleDialog(
                                ...
                                children: [
                                  ListTile(
                                    title: const Text(
                                      'Sleep after a Duration',
                                    ),
                                    subtitle: const Text(
                                      'Music will stop after given time',
                                    ),
                                    dense: true,
                                    onTap: () {
                                      Navigator.pop(context);
...
class NameNControls extends StatelessWidget {
  ...
  void fetchLyrics() {
    Logger.root.info('Fetching lyrics for ${mediaItem.title}');
    done.value = false;
    lyricsSource.value = '';
    if (offline) {
      Lyrics.getOffLyrics(
  ...
  Widget build(BuildContext context) {
    ...
    // final double nowplayingBoxHeight =  height * 0.50;
